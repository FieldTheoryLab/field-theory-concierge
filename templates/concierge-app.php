...
<div class="ftc-app" data-ftc-app data-theme="dark">
  ...
  <div class="ftc-prompt-dock" data-ftc-prompt-dock>
    <button class="ftc-help-dot" type="button" data-ftc-help-menu aria-label="Open helpful prompts">?</button>
    <form class="ftc-chat-form ftc-bottom-search" data-ftc-chat-form>
      <div class="ftc-input-shell"><input type="text" data-ftc-chat-input placeholder="<?php echo esc_attr($s['input_placeholder']); ?>" autocomplete="off"><button class="ftc-clear" type="button" data-ftc-clear aria-label="Clear conversation">&times;</button><button class="ftc-send" type="submit" aria-label="Send">CHAT</button></div>
    </form>
  ...
  <div class="ftc-modal" data-ftc-modal aria-hidden="true"><button class="ftc-modal-bg" type="button" data-ftc-close aria-label="Close"></button><aside class="ftc-modal-panel"><button class="ftc-modal-close" type="button" data-ftc-close aria-label="Close">&times;</button><h2>Explore Field Theory</h2><div data-ftc-menu-content><div class="ftc-loader"></div></div></aside></div>
  <div class="ftc-help-modal" data-ftc-help-modal aria-hidden="true">
